...
var _ClientCredentialsStrategy = class _ClientCredentialsStrategy {
...
__publicField(_ClientCredentialsStrategy, "cacheKey", "spotify-sdk:ClientCredentialsStrategy:token");
...
var _ImplicitGrantStrategy = class _ImplicitGrantStrategy {
...
__publicField(_ImplicitGrantStrategy, "cacheKey", "spotify-sdk:ImplicitGrantStrategy:token");
...
var _AuthorizationCodeWithPKCEStrategy = class _AuthorizationCodeWithPKCEStrategy {
  constructor(clientId, redirectUri, scopes) {
    __publicField(this, "clientId");
    __publicField(this, "redirectUri");
    __publicField(this, "scopes");
...
__publicField(_AuthorizationCodeWithPKCEStrategy, "cacheKey", "spotify-sdk:AuthorizationCodeWithPKCEStrategy:token");
...
__publicField(_SpotifyApi, "rootUrl", "https://api.spotify.com/v1/");
